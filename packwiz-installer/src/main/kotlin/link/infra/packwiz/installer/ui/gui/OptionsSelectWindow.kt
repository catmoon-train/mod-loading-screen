...
class OptionsSelectWindow internal constructor(optList: List<IOptionDetails>, future: CompletableFuture<Boolean>, parentWindow: JFrame?) : JDialog(parentWindow, "选择可选模组...", true), ActionListener {
	...
	private class OptionTableModel(givenOpts: List<IOptionDetails>) : TableModel {
		...
		private val columnNames = arrayOf("启用", "模组名")
		...
		contentPane.apply {
			...
			add(JPanel().apply {
				...
				add(JSplitPane().apply {
					...
					lblOptionDescription = JTextArea("请选择一个选项...").apply {
					...
					leftComponent = JScrollPane(JTable().apply {
						...
						selectionModel.addListSelectionListener {
							...
							if (i > -1) {
								...
								lblOptionDescription.text = "请选择一个选项..."
							}
						}
						tableHeader = null
					}).apply {
